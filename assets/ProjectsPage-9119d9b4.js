...
`}]}];return(g,c)=>(s(),r(u,null,[a("div",V,[a("div",K,[a("div",X,[a("h1",W,i(b(e).PROJECTS),1),a("p",Z,i(b(e).DESCRIPTION),1)])])]),$,a("main",ee,[(s(!0),r(u,null,A(S.value,l=>(s(),r("div",{key:l.groupName,class:"project-group"},[a("h2",te,i(l.groupName),1),a("div",ae,[(s(!0),r(u,null,A(l.projects,t=>(s(),r("div",{class:"project",key:t.name},[a("div",se,[a("div",re,[k(t.name)?(s(),r("div",ie,i(T(t.name)),1)):(s(),r("img",{key:0,class:"project-title",src:`/assets/img/logo/${t.name}.webp`,alt:t.name},null,8,oe)),a("div",me,[h.value=="zh-CN"||h.value=="/zh/"?(s(),r(u,{key:0},[E.includes(t.name)?d("v-if",!0):(s(),r("a",{key:0,href:`https://gitee.com/dromara/${t.name}/stargazers`,target:"_blank"},[a("img",{src:`https://gitee.com/dromara/${t.name}/badge/star.svg?theme=gvp`},null,8,he)],8,ge))],64)):(s(),r(u,{key:1},[_.includes(t.name)?d("v-if",!0):(s(),j(b(Y),{key:0,project:t.name},null,8,["project"]))],64))])]),a("div",ce,i(t.description),1)]),a("div",le,[t.sponsor?(s(),r("p",de,i(b(e).PROJECT_SPONSOR)+"："+i(t.sponsor),1)):d("v-if",!0),t.date?(s(),r("p",ne,i(b(e).JOINING_DATE)+"："+i(t.date),1)):d("v-if",!0),a("p",{innerHTML:t.link},null,8,pe)]),a("div",be,[a("a",{class:"project-button primary",target:"_blank",href:t.website},i(b(e).START_UP),9,ue),E.includes(t.name)?d("v-if",!0):(s(),r("a",{key:0,class:"project-button",target:"_blank",href:`https://gitee.com/dromara/${t.name}`},"Gitee",8,Fe)),_.includes(t.name)?d("v-if",!0):(s(),r("a",{key:1,class:"project-button",target:"_blank",href:`https://github.com/dromara/${t.name}`},"Github",8,fe))])]))),128))])]))),128))])],64))}});const Se=w(Ee,[["__scopeId","data-v-9ef6d51a"],["__file","ProjectsPage.vue"]]);export{Se as P};
