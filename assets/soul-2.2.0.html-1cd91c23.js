...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>访问 http://localhost:9095/index.html 默认的用户名：admin 密码:123456。</li></ul><p><strong>搭建属于你的网关</strong></p><ul><li>首先你新建一个空的 springboot 项目，可以参考 soul-bootstrap. 也可以在 spring 官网:[https://spring.io/quickstart]</li><li>引入如下 jar 包：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  &lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>这样网关的环境就已经搭建完成。</li></ul><h2 id="体验新架构下的插件热插拔" tabindex="-1"><a class="header-anchor" href="#体验新架构下的插件热插拔" aria-hidden="true">#</a> 体验新架构下的插件热插拔</h2><ul><li><p>问：我想使用熔断功能，应该如何做呢？</p></li><li><p>答：你可以在 pom.xml 文件 引入以下依赖,更多的还请看：https://dromara.org/zh-cn/docs/soul/soul.html</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  &lt;!-- soul hystrix plugin start--&gt;
  &lt;dependency&gt;
      &lt;groupId&gt;org.dromara&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>问:我怎么接入 dubbo 服务呢？</p></li><li><p>答： 1）如果你使用的是 alibaba-dubbo，那么你应该引入如下：</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>   &lt;!--soul alibaba dubbo plugin start--&gt;
    &lt;dependency&gt;
          &lt;groupId&gt;org.dromara&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>更多的使用请你参考：https://dromara.org/zh-cn/docs/soul/user-dubbo.html</li></ol><ul><li><p>问：如果我想使用限流功能呢？</p></li><li><p>答：你可以引入以下依赖，具体的参考：https://dromara.org/zh-cn/docs/soul/plugin-rateLimiter.html</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  &lt;!-- soul ratelimiter plugin start--&gt;
  &lt;dependency&gt;
      &lt;groupId&gt;org.dromara&lt;/groupId&gt;
