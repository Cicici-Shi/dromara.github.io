import{f as A,j as E,z as C,o as s,c as r,a,t as o,e as l,x as T,y as I,_ as D,i as N,p as O,q as R,g as b,F as u,l as k,A as L}from"./app-08b63838.js";const P={PROJECTS:"Projects",DESCRIPTION:"Dromara Open Source Community gathers top-tier open-source project authors, offering open-source products, solutions, consulting, support, and training. Encompassing domains like distributed transactions, tools, authentication, microservice RPC, monitoring, logging, and big data. Join us to experience the joy of open source.",PROJECT_SPONSOR:"Project sponsor",JOINING_DATE:"Joining date",START_UP:"Start up",DISTRIBUTED_TRANSACTION:"Distributed Transaction",HMILY_DESC:"Flexible distributed transaction solution",RAINCAT_DESC:"Strongly consistent distributed transaction solution",MYTH_DESC:"Reliable messages distributed transaction solution",POPULAR_TOOLS:"Popular Tools",HUTOOL_DESC:"A set of tools that keep Java sweet",FOREST_DESC:"A high-level and lightweight HTTP client framework for Java",LITEFLOW_DESC:"a lightweight and practical micro-process framework",DYNAMIC_TP_DESC:"Lightweight dynamic threadpool with monitoring and alarming",EASY_ES_DESC:"An easier-to-use ES search engine framework, born to simplify development",GO_VIEW_DESC:"A efficient low-code data visualization development platform",IMAGE_COMBINER_DESC:"Image combine tool for java server side",JINX_DESC:"Netty is used as httpServer in Spring-boot",ELECTRON_EGG_DESC:"A simple, cross-platform, enterprise-level desktop software development framework.",NORTHSTAR_DESC:"Quantitative Trading Platform",EASY_TRANS_DESC:"Data translation with an annotation.Write 30% less code",FAST_REQUEST_DESC:"A plugin in jetbrain intellij idea that looks like Postman.",REDISFRONT_DESC:"An open-source cross-platform Redis GUI.",X_EASYPDF_DESC:"A framework for constructing PDFs in a building-block manner (based on PDFBox).",GOBRS_ASYNC_DESC:"A powerful, flexible-configured asynchronous orchestration framework with full link exception callback, memory optimization, and exception state management.",OPEN_GITEYE_API_DESC:"A data chart service tool designed specifically for open source authors, providing services including Star trend charts, contributor lists, and Gitee indexes.",BINLOG4J_DESC:"A lightweight Mysql Binlog client based on Java.",SMS4J_DESC:"SMS4J is a text messaging aggregation framework that makes it easy to integrate services from multiple providers.",STREAM_QUERY_DESC:"Experience mybatis-plus without the need for Mappers!",PAYMENT_SPRING_BOOT_DESC:"The most complete and easy-to-use WeChat Payment V3 component for Spring Boot.",EASYTRANS_DESC:"Data translation with just one annotation, reducing SQL code by 30%.",NEUTRINO_PROXY_DESC:"An open-source Java intranet penetration project based on netty.",TESTHUB_DESC:"An automation testing tool based on workflow orchestration.",YFT_DESIGN_DESC:"An open-source version of 'Creator Post' based on Canvas.",ZYPLAYER_DOC_DESC:"A knowledge base, note, and WIKI documentation management tool suitable for team and individual private deployment.",ENTERPRISE_CERTIFICATION:"Enterprise Certification",SA_TOKEN_DESC:"The most comprehensive Java permission framework",MAXKEY_DESC:"MaxKey Leading Edge Enterprise Class open source IAM product",SURENESS_DESC:"Focusing on Protection of REST API",OPERATIONS_AND_MAINTENANCE_CONTROL:"Operations and Maintenance Control",JPOM_DESC:"Simple & Low-intrusion project management platform",HERTZBEAT_DESC:"Friendly apm - monitor and alarm system.",CUBIC_DESC:"Distributed monitoring system",ATHENA_DESC:"Metrics bytecode tool",DISTRIBUTED_LOG:"Distributed Log",TLOG_DESC:"Lightweight distributed log label tracking framwork",AGENT_MONITORING:"Agent Monitoring",CLOUDEON_DESC:"A cloud-native big data platform based on Kubernetes, dedicated to simplifying the operation and maintenance of big data clusters on k8s.",DATA_COMPARE_DESC:"Database comparison tool: comparison of hive table data, and comparison of mysql, Doris data.",MICROSERVICE:"Microservice",KOALAS_RPC_DESC:"Highly available and extensible RPC framework",MENDMIX_DESC:"A technology base for distributed architecture and cloud native architecture",LAMP_CLOUD_DESC:"A rapid development platform for the middle and back office of microservices focusing on multi tenant solutions",DANTE_CLOUD_DESC:"Enterprise level microservice architecture based on spring authorization server and OAuth 2.1 protocol",OPEN_CAPACITY_PLATFORM_DESC:"Spring Cloud-based enterprise microservices framework",RUOYI_VUE_PLUS_DESC:"A backend management system that rewrites all features of RuoYi-Vue, integrating Sa-Token, Mybatis-Plus, Jackson, Xxl-Job, SpringDoc, Hutool, and OSS.",J2EEFAST_DESC:"J2eeFAST is a Java EE enterprise-level fast development platform. ",DISTRIBUTED_SCHEDULING:"Distributed Scheduling",HODOR_DESC:"Distributed scheduling framework",DISJOB_DESC:"A distributed task scheduling framework."},j={PROJECTS:"项目",DESCRIPTION:"Dromara开源社区，汇集一流开源项目作者，提供开源产品、解决方案、咨询、支持和培训。涵盖分布式事务、工具、认证、微服务RPC、监控、日志、大数据等领域。加入我们，体验开源的乐趣。",PROJECT_SPONSOR:"项目sponsor",JOINING_DATE:"加入时间",START_UP:"开始",DISTRIBUTED_TRANSACTION:"分布式事务",HMILY_DESC:"柔性分布式事务解决方案",RAINCAT_DESC:"强一致性分布式事务解决方案",MYTH_DESC:"可靠消息分布式事务解决方案",POPULAR_TOOLS:"流行工具",HUTOOL_DESC:"小而全的Java工具类库",FOREST_DESC:"更轻量，更简单实用的HTTP客户端框架",LITEFLOW_DESC:"轻量，快速，稳定，可编排的组件式流程引擎",DYNAMIC_TP_DESC:"基于配置中心的轻量级动态线程池，内置监控告警功能",EASY_ES_DESC:"更易用的ES搜索引擎框架",GO_VIEW_DESC:"高效的低代码「数据可视化」开发平台",IMAGE_COMBINER_DESC:"Java服务端图片合成工具",JINX_DESC:"Spring-boot http服务:netty",ELECTRON_EGG_DESC:"一个入门简单、跨平台、企业级桌面软件开发框架",NORTHSTAR_DESC:"量化交易平台",EASY_TRANS_DESC:"一个注解搞定数据翻译,减少30%SQL代码量",FAST_REQUEST_DESC:"基于jetbrains intellij idea的postman插件",REDISFRONT_DESC:"一款开源跨平台Redis 桌面客户端工具",X_EASYPDF_DESC:"一个用搭积木的方式构建pdf的框架（基于pdfbox）",GOBRS_ASYNC_DESC:"一款功能强大、配置灵活、带有全链路异常回调、内存优化、异常状态管理于一身的高性能异步编排框架",OPEN_GITEYE_API_DESC:"专为开源作者设计的数据图表服务工具类站点，提供了包括Star趋势图、贡献者列表、Gitee指数等数据图表服务。",BINLOG4J_DESC:"基于 Java 轻量级的 Mysql Binlog 客户端。",SMS4J_DESC:"SMS4J为短信聚合框架，帮您轻松集成多家短信服务。",STREAM_QUERY_DESC:"允许完全摆脱Mapper的mybatis-plus体验！",PAYMENT_SPRING_BOOT_DESC:"最全最好用的微信支付V3 Spring Boot 组件。",EASYTRANS_DESC:"一个注解搞定数据翻译,减少30%SQL代码量。",NEUTRINO_PROXY_DESC:"一个基于netty的、开源的java内网穿透项目。",TESTHUB_DESC:"一款基于流程编排的自动化测试工具。",YFT_DESIGN_DESC:"基于Canvas的开源版“创客贴”。",ZYPLAYER_DOC_DESC:"一款适合团队和个人私有化部署使用的知识库、笔记、WIKI文档管理工具。",ENTERPRISE_CERTIFICATION:"企业级认证",SA_TOKEN_DESC:"史上功能最全的 Java 权限认证框架",MAXKEY_DESC:"业界领先的企业级开源IAM身份管理和身份认证产品",SURENESS_DESC:"面向REST API的高性能认证鉴权框架",OPERATIONS_AND_MAINTENANCE_CONTROL:"运维管控",JPOM_DESC:"简而轻的低侵入式在线构建、自动部署、日常运维、项目监控软件",HERTZBEAT_DESC:"易用友好的高性能监控告警系统",CUBIC_DESC:"无侵入分布式监控，致力于应用级监控的工具",ATHENA_DESC:"metrics 字节码工具",DISTRIBUTED_LOG:"分布式日志",TLOG_DESC:"轻量级的分布式日志标记追踪神器",BIG_DATA:"大数据",CLOUDEON_DESC:"一款基于kubernetes的云原生大数据平台，致力于简化k8s上大数据集群的运维管理。",DATA_COMPARE_DESC:"数据库比对工具: hive 表数据比对，mysql、Doris 数据比对。",MICROSERVICE:"微服务",KOALAS_RPC_DESC:"高可用可拓展的RPC框架",MENDMIX_DESC:"一站式分布式云原生架构技术底座",LAMP_CLOUD_DESC:"专注于多租户(SaaS架构)解决方案的微服务中后台快速开发平台",DANTE_CLOUD_DESC:"基于 Spring Authorization Server 全新适配 OAuth 2.1 协议的企业级微服务架构",OPEN_CAPACITY_PLATFORM_DESC:"基于Spring Cloud的企业级微服务框架",RUOYI_VUE_PLUS_DESC:"后台管理系统 重写RuoYi-Vue所有功能 集成 Sa-Token+Mybatis-Plus+Jackson+Xxl-Job+SpringDoc+Hutool+OSS",J2EEFAST_DESC:"J2eeFAST 是一个 Java EE 企业级快速开发平台。",DISTRIBUTED_SCHEDULING:"分布式调度",HODOR_DESC:"分布式调度框架",DISJOB_DESC:"一个分布式的任务调度框架。"},B=n=>(T("data-v-9a3b644e"),n=n(),I(),n),q={class:"github-star"},G=["href"],M=B(()=>a("svg",{viewBox:"0 0 16 16",width:"16",height:"16",class:"octicon octicon-star","aria-hidden":"true"},[a("path",{d:"M8 .25a.75.75 0 0 1 .673.418l1.882 3.815 4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97.719 4.192a.751.751 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25Zm0 2.445L6.615 5.5a.75.75 0 0 1-.564.41l-3.097.45 2.24 2.184a.75.75 0 0 1 .216.664l-.528 3.084 2.769-1.456a.75.75 0 0 1 .698 0l2.77 1.456-.53-3.084a.75.75 0 0 1 .216-.664l2.24-2.183-3.096-.45a.75.75 0 0 1-.564-.41L8 2.694Z"})],-1)),J=[M],x=["href"],z=A({__name:"GitHubStars",props:{project:String},setup(n){const t=n,p=E();C(()=>{t.project!==null&&t.project!==void 0&&fetch(`https://api.github.com/repos/dromara/${t.project}`,{headers:{accept:"*/*","accept-language":"zh-CN,zh;q=0.9","sec-ch-ua":'"Not/A)Brand";v="99", "Google Chrome";v="115", "Chromium";v="115"',"sec-ch-ua-mobile":"?0","sec-ch-ua-platform":'"macOS"',"sec-fetch-dest":"empty","sec-fetch-mode":"cors","sec-fetch-site":"cross-site"},referrer:"https://dromara.org/",referrerPolicy:"strict-origin-when-cross-origin",body:null,method:"GET",mode:"cors",credentials:"omit"}).then(async i=>{if(!i.ok)throw new Error("Network response was not ok");return await i.json()}).then(i=>{p.value=m(i.stargazers_count)}).catch(i=>{console.error("Error:",i)})});const m=function(i){if(typeof i>"u")return"";const d=i.toString().split(".");return d[0]=d[0].replace(/\B(?=(\d{3})+(?!\d))/g,","),d.join(".")};return(i,d)=>(s(),r("div",q,[a("a",{class:"github-button",href:`https://github.com/repos/dromara/${t.project}`},J,8,G),p.value?(s(),r("a",{key:0,class:"social-count",href:`https://github.com/dromara/${t.project}/stargazers`,rel:"noopener",target:"_blank"},o(p.value),9,x)):l("v-if",!0)]))}});const U=D(z,[["__scopeId","data-v-9a3b644e"],["__file","GitHubStars.vue"]]),Y={class:"projects-page"},H={class:"project-container"},V={class:"title"},Q={class:"description"},K={class:"project-main"},X={class:"group-name"},Z={class:"project-card"},$={class:"project-top"},W={class:"project-header"},tt=["src","alt"],et={key:1,class:"project-title text"},at={class:"gitstar"},st=["href"],rt=["src"],it={class:"project-content"},ot={class:"hiding-detail"},gt={key:0},mt={key:1},ht=["innerHTML"],ct={class:"project-buttons"},lt=["href"],nt=["href"],pt=["href"],dt=A({__name:"ProjectsPage",setup(n){let t=N({PROJECTS:"",DESCRIPTION:"",PROJECT_SPONSOR:"",JOINING_DATE:"",START_UP:"",DISTRIBUTED_TRANSACTION:"",HMILY_DESC:"",RAINCAT_DESC:"",MYTH_DESC:"",POPULAR_TOOLS:"",HUTOOL_DESC:"",FOREST_DESC:"",LITEFLOW_DESC:"",DYNAMIC_TP_DESC:"",EASY_ES_DESC:"",GO_VIEW_DESC:"",IMAGE_COMBINER_DESC:"",JINX_DESC:"",ELECTRON_EGG_DESC:"",NORTHSTAR_DESC:"",EASY_TRANS_DESC:"",FAST_REQUEST_DESC:"",REDISFRONT_DESC:"",X_EASYPDF_DESC:"",GOBRS_ASYNC_DESC:"",OPEN_GITEYE_API_DESC:"",BINLOG4J_DESC:"",SMS4J_DESC:"",STREAM_QUERY_DESC:"",PAYMENT_SPRING_BOOT_DESC:"",EASYTRANS_DESC:"",NEUTRINO_PROXY_DESC:"",TESTHUB_DESC:"",YFT_DESIGN_DESC:"",ZYPLAYER_DOC_DESC:"",ENTERPRISE_CERTIFICATION:"",SA_TOKEN_DESC:"",MAXKEY_DESC:"",SURENESS_DESC:"",OPERATIONS_AND_MAINTENANCE_CONTROL:"",JPOM_DESC:"",HERTZBEAT_DESC:"",CUBIC_DESC:"",ATHENA_DESC:"",DISTRIBUTED_LOG:"",TLOG_DESC:"",BIG_DATA:"",CLOUDEON_DESC:"",DATA_COMPARE_DESC:"",MICROSERVICE:"",KOALAS_RPC_DESC:"",MENDMIX_DESC:"",LAMP_CLOUD_DESC:"",DANTE_CLOUD_DESC:"",OPEN_CAPACITY_PLATFORM_DESC:"",RUOYI_VUE_PLUS_DESC:"",J2EEFAST_DESC:"",DISTRIBUTED_SCHEDULING:"",HODOR_DESC:"",DISJOB_DESC:""});const p=O(),m=E(p.value.lang);R(()=>p.value.lang,g=>{m.value=g,m.value==="zh-CN"||m.value==="/zh/"?t=j:t=P},{immediate:!0});const i=[{groupName:t.ENTERPRISE_CERTIFICATION,projects:["sa-token","MaxKey","sureness"]},{groupName:t.POPULAR_TOOLS,projects:["hutool","go-view","liteFlow","electron-egg","easy-es","forest","northstar","dynamic-tp","x-easypdf","image-combiner","easy_trans","gobrs-async","redisfront","fast-request","Binlog4j","open-giteye-api","jinx"]},{groupName:t.MICROSERVICE,projects:["open-capacity-platform","RuoYi-Vue-Plus","lamp-cloud","mendmix","koalas-rpc","dante-cloud","J2EEFAST"]},{groupName:t.OPERATIONS_AND_MAINTENANCE_CONTROL,projects:["Jpom","hertzbeat","cubic","athena"]},{groupName:t.DISTRIBUTED_LOG,projects:["TLog"]},{groupName:t.DISTRIBUTED_TRANSACTION,projects:["hmily","myth","Raincat"]},{groupName:t.BIG_DATA,projects:["data-compare","CloudEon"]},{groupName:t.DISTRIBUTED_SCHEDULING,projects:["Disjob","hodor"]}];function d(g,h){return h.map(c=>{const e=g.find(f=>f.groupName===c.groupName);return e?{groupName:c.groupName,projects:c.projects.map(f=>e.projects.find(w=>w.name===f)||null).filter(Boolean)}:null}).filter(Boolean)}C(()=>{F.value=d(F.value,i)});const v=g=>["jinx","athena","open-capacity-platform","hodor","data-compare","Binlog4j"].includes(g),y=g=>g.replace(/-([a-z])/g,h=>h.toUpperCase()).replace(/^([a-z])/,h=>h.toUpperCase()),_=["jinx","athena"],S=["zyplayer-doc","easy-trans","x-easypdf","image-combiner"],F=E([{groupName:t.DISTRIBUTED_TRANSACTION,projects:[{name:"hmily",website:"https://dromara.org/zh/projects/hmily/overview/",description:t.HMILY_DESC,sponsor:"肖宇（yu199195）",date:"2017.09",link:`<a target="_blank" href="https://search.maven.org/search?q=g:org.dromara%20AND%20hmily">
   ...
   </a>`},{name:"Raincat",website:"https://dromara.org/zh/projects/raincat/overview/",description:t.RAINCAT_DESC,sponsor:"肖宇（yu199195）",date:"2017.09",link:`<a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fyu199195%2Fraincat"><img src="https://tokei.rs/b1/github/yu199195/raincat?category=lines" alt="Total lines"></a>
...
<a href="https://gitee.com/link?target=https%3A%2F%2Fshang.qq.com%2Fwpa%2Fqunwpa%3Fidkey%3D2e9e353fa10924812bc58c10ab46de0ca6bef80e34168bccde275f7ca0cafd85"><img src="https://img.shields.io/badge/chat-on%20QQ-ff69b4.svg?style=flat-square" alt="QQ群"></a>`},{name:"myth",website:"https://dromara.org/zh/projects/myth/overview/",description:t.MYTH_DESC,sponsor:"肖宇（yu199195）",date:"2017.12",link:`<a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fyu199195%2Fmyth"><img src="https://tokei.rs/b1/github/yu199195/myth?category=lines" alt="Total lines"></a>
...
<a href="https://gitee.com/link?target=https%3A%2F%2Fshang.qq.com%2Fwpa%2Fqunwpa%3Fidkey%3D2e9e353fa10924812bc58c10ab46de0ca6bef80e34168bccde275f7ca0cafd85"><img src="https://img.shields.io/badge/chat-on%20QQ-ff69b4.svg?style=flat-square" alt="QQ群"></a></p>`}]},{groupName:t.POPULAR_TOOLS,projects:[{name:"hutool",website:"https://hutool.cn/",description:t.HUTOOL_DESC,sponsor:"Looly（loolly_admi）",date:"2021.03",link:`
  	...
  	<img src="https://img.shields.io/badge/QQ%E7%BE%A4%E2%91%A6-715292493-orange"></a>`},{name:"forest",website:"https://forest.dtflyx.com/",description:t.FOREST_DESC,sponsor:"公子骏（dt_flys）",date:"2021.03",link:`<a href="https://gitee.com/dromara/forest">
  ...
  </a>`},{name:"liteFlow",website:"https://yomahub.com/liteflow/",description:t.LITEFLOW_DESC,sponsor:"铂赛东（bryan31）",date:"2021.03",link:`
  ...
  `},{name:"dynamic-tp",website:"https://juejin.cn/column/7053801521502224392",description:t.DYNAMIC_TP_DESC,sponsor:"yanhom",date:"2022.04",link:`
  ...
  `},{name:"easy-es",website:"https://easy-es.cn/",description:t.EASY_ES_DESC,sponsor:"elasticsearch（easy-es）",date:"2022.03",link:`
   ...
   `},{name:"go-view",website:"http://www.mtruning.club:81/",description:t.GO_VIEW_DESC,sponsor:"奔跑的面条（MTrun）",date:"2022.09",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fgo-view%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/go-view.svg?style=flat-square"></a>
          `},{name:"image-combiner",website:"http://dromara.gitee.io/image-combiner",description:t.IMAGE_COMBINER_DESC,sponsor:"alexzchen",date:"2021.03",link:`
  ...
  `},{name:"jinx",website:"https://dromara.org/zh/projects/jinx/overview",description:t.JINX_DESC,sponsor:"肖宇（yu199195）",date:"",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fjinx%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/jinx.svg?style=flat-square"></a>
          `},{name:"electron-egg",website:"https://www.yuque.com/u34495/mivcfg",description:t.ELECTRON_EGG_DESC,sponsor:"哆啦好梦（wallace530）",date:"2022.12",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Felectron-egg%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/electron-egg.svg?style=flat-square"></a>
          `},{name:"northstar",website:"https://www.quantit.tech/",description:t.NORTHSTAR_DESC,sponsor:"Huangwl（kevinhuang）",date:"2021.07",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fnorthstar%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/northstar.svg?style=flat-square"></a>
          `},{name:"easy_trans",website:"http://easy-trans.fhs-opensource.top/",description:t.EASY_TRANS_DESC,sponsor:"fhs_opensource",date:"2023.01",link:`
  ...
  `},{name:"fast-request",website:"https://dromara.org/fast-request",description:t.FAST_REQUEST_DESC,sponsor:"kings",date:"2021.12",link:`<a href="https://gitee.com/link?target=https%3A%2F%2Fjoin.slack.com%2Ft%2Frestfulfastrequest%2Fshared_invite%2Fzt-1we57vum8-TALhTHI2uNmPF2bx1NDyWw"><img src="https://img.shields.io/static/v1?label=Slack&amp;message=Restful-Fast-Request&amp;logo=slack&amp;color=38B580" alt="Slack"></a>
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fwww.oscs1024.com%2Fproject%2Fdromara%2Ffast-request%3Fref%3Dbadge_small"><img src="https://www.oscs1024.com/platform/badge/dromara/fast-request.svg?size=small" alt="OSCS Status"></a>`},{name:"redisfront",website:"https://www.redisfront.com/",description:t.REDISFRONT_DESC,sponsor:"westboy",date:"2022.12",link:`<img src="https://img.shields.io/badge/JDK-17-blue.svg" alt="JDK">
  <img src="https://img.shields.io/badge/Apache-2.0-4green.svg" alt="Apache 2.0">
  <img src="https://img.shields.io/badge/Release-1.0.7-green.svg" alt="Release">`},{name:"x-easypdf",website:"http://www.x-easypdf.cn/",description:t.X_EASYPDF_DESC,sponsor:"xsx（xsxgit）",date:"2022.07",link:`
  ...
  <a href="https://gitee.com/dromara/x-easypdf/members"><img src="https://gitee.com/dromara/x-easypdf/badge/fork.svg"></a>
          `},{name:"gobrs-async",website:"https://async.sizegang.cn/",description:t.GOBRS_ASYNC_DESC,sponsor:"Memorydoc",date:"2022.06",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fgobrs-async%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/gobrs-async.svg?style=flat-square"></a>
          `},{name:"open-giteye-api",website:"https://giteye.net/",description:t.OPEN_GITEYE_API_DESC,sponsor:"公子骏（dt_flys）、铂赛东（bryan31）",date:"2021.03",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fopen-giteye-api%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/open-giteye-api.svg?style=flat-square"></a>
          `},{name:"Binlog4j",website:"https://gitee.com/dromara/binlog4j",description:t.BINLOG4J_DESC,sponsor:"就眠儀式（Jmysy）",date:"2023.08",link:`
  ...
  `},{name:"sms4j",website:"https://wind.kim/",description:t.SMS4J_DESC,sponsor:"风如歌（MR-wind）",date:"2023.04",link:`
  ...
  `},{name:"stream-query",website:"http://stream-query.dromara.org/",description:t.STREAM_QUERY_DESC,sponsor:"阿超（VampireAchao）",date:"2023.03",link:`
  ...
  `},{name:"payment-spring-boot",website:"https://felord.gitee.io/payment-spring-boot",description:t.PAYMENT_SPRING_BOOT_DESC,sponsor:"felord",date:"2023.03",link:`
  ...
  `},{name:"Neutrino-Proxy",website:"https://gitee.com/dromara/neutrino-proxy",description:t.NEUTRINO_PROXY_DESC,sponsor:"傲世孤尘（asgc）",date:"2023.01",link:`
  ...
  `},{name:"TestHub",website:"http://nsrule.com/",description:t.TESTHUB_DESC,sponsor:"失败女神（failedgoddes）",date:"2023.08",link:`
  ...
  `},{name:"yft-design",website:"https://www.yft.design/",description:t.YFT_DESIGN_DESC,sponsor:"Nevermore（morestrive）",date:"2023.08",link:`
  ...
  `},{name:"zyplayer-doc",website:"http://doc.zyplayer.com/",description:t.ZYPLAYER_DOC_DESC,sponsor:"暮光：城中城（zyplayer）",date:"2023.02",link:`
  ...
  <a href="https://gitee.com/dromara/zyplayer-doc/members"><img src="https://gitee.com/dromara/zyplayer-doc/badge/fork.svg"></a>
          `}]},{groupName:t.ENTERPRISE_CERTIFICATION,projects:[{name:"sa-token",website:"http://sa-token.dev33.cn/",description:t.SA_TOKEN_DESC,sponsor:"刘潇（click33）",date:"2021.03",link:`
  ...
  </p>`},{name:"MaxKey",website:"https://maxkey.top/",description:t.MAXKEY_DESC,sponsor:"MaxKeyTop（maxkeytop_admin）",date:"2021.03",link:`
  ...
  `},{name:"sureness",website:"https://dromara.org/sureness",description:t.SURENESS_DESC,sponsor:"tomsun28",date:"2021.05",link:`<a href="https://gitee.com/link?target=https%3A%2F%2Fwww.apache.org%2Flicenses%2FLICENSE-2.0.html"><img src="https://img.shields.io/badge/license-Apache%202-4EB1BA.svg" alt="License"></a>
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fsureness"><img src="https://img.shields.io/github/stars/dromara/sureness?style=social" alt="star"></a>`}]},{groupName:t.OPERATIONS_AND_MAINTENANCE_CONTROL,projects:[{name:"Jpom",website:"https://jpom.io/",description:t.JPOM_DESC,sponsor:"蒋小小（bwcx-jzy）",date:"2021.03",link:`
      ...
      <a target="_blank" href="https://gitee.com/link?target=https%3A%2F%2Fhub.docker.com%2Frepository%2Fdocker%2Fjpomdocker%2Fjpom">
          ...
          `},{name:"hertzbeat",website:"https://hertzbeat.com/",description:t.HERTZBEAT_DESC,sponsor:"tomsun28",date:"2022.02",link:`
  ...
  `},{name:"cubic",website:"https://cubic.jiagoujishu.com/",description:t.CUBIC_DESC,sponsor:"QIANGLU（qianglu）",date:"2021.03",link:`<a href="https://gitee.com/dromara/cubic"><img src="https://gitee.com/dromara/cubic/badge/star.svg"></a>
  ...
  `},{name:"athena",website:"https://dromara.org/zh/projects/raincat/overview/",description:t.ATHENA_DESC,sponsor:"肖宇（yu199195）",date:"",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fathena%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/athena.svg?style=flat-square"></a>
          `}]},{groupName:t.DISTRIBUTED_LOG,projects:[{name:"TLog",website:"https://yomahub.com/tlog/",description:t.TLOG_DESC,sponsor:"铂赛东（bryan31）",date:"2021.03",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2FTLog%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/TLog.svg?style=flat-square"></a>
          `}]},{groupName:t.BIG_DATA,projects:[{name:"CloudEon",website:"http://www.cloudeon.top/",description:t.CLOUDEON_DESC,sponsor:"Pandas886",date:"2023.04",link:`<a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2FCloudEon"><img src="https://views.whatilearened.today/views/github/dromara/CloudEon.svg" alt="HitCount"></a>
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2FCloudEon%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/CloudEon" alt="GitHub license"></a>`},{name:"data-compare",website:"https://blog.csdn.net/weixin_43291055/article/details/128393823?spm=1001.2014.3001.5502",description:t.DATA_COMPARE_DESC,sponsor:"诸葛子房（ZhuGeZiFang）",date:"2023.03",link:`
  ...
  <img src="https://img.shields.io/github/v/release/zhugezifang/dataCompare?label=latest&amp;style=flat-square" alt="">`}]},{groupName:t.MICROSERVICE,projects:[{name:"koalas-rpc",website:"https://github.com/dromara/koalas-rpc",description:t.KOALAS_RPC_DESC,sponsor:"张玉龙（a12345678）",date:"2021.06",link:`
  ...
  `},{name:"mendmix",website:"https://www.jeesuite.com/",description:t.MENDMIX_DESC,sponsor:"vakinge",date:"2022.05",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fmendmix%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/mendmix.svg?style=flat-square"></a>
          `},{name:"lamp-cloud",website:"https://tangyh.top/",description:t.LAMP_CLOUD_DESC,sponsor:"最后（zuihou111）",date:"2022.11",link:`
  ...
  `},{name:"dante-cloud",website:"https://www.herodotus.cn/",description:t.DANTE_CLOUD_DESC,sponsor:"码匠君（herodotus）",date:"2022.08",link:`
  ...
  `},{name:"open-capacity-platform",website:"https://gitee.com/dromara/open-capacity-platform/",description:t.OPEN_CAPACITY_PLATFORM_DESC,sponsor:"owen（jeecp）",date:"2023.01",link:`
  ...
  `},{name:"RuoYi-Vue-Plus",website:"https://plus-doc.dromara.org/",description:t.RUOYI_VUE_PLUS_DESC,sponsor:"疯狂的狮子Li（JavaLionLi）",date:"2023.04",link:`
  ...
  <a href=""><img src="https://img.shields.io/badge/JDK-11-green.svg" alt="JDK-11"></a>`},{name:"J2EEFAST",website:"http://www.j2eefast.com/",description:t.J2EEFAST_DESC,sponsor:"周周（zhouhuanOGP）",date:"2023.03",link:`
  ...
  `}]},{groupName:t.DISTRIBUTED_SCHEDULING,projects:[{name:"hodor",website:"https://dromara.org/zh/projects/hodor/overview",description:t.HODOR_DESC,sponsor:"tincopper（tomgs）",date:"2023.04",link:`
...
<a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fhodor%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/hodor.svg?style=flat-square"></a>
        `},{name:"Disjob",website:"http://ponfee.cn:8000/login",description:t.DISJOB_DESC,sponsor:"ponfee（fupengfei）",date:"2023.08",link:`
...
`}]}]);return t.DISTRIBUTED_TRANSACTION,t.DISTRIBUTED_SCHEDULING,(g,h)=>(s(),r(u,null,[a("div",Y,[a("div",H,[a("h1",V,o(b(t).PROJECTS),1),a("p",Q,o(b(t).DESCRIPTION),1)])]),a("main",K,[(s(!0),r(u,null,k(F.value,c=>(s(),r("div",{key:c.groupName,class:"project-group"},[a("h2",X,o(c.groupName),1),a("div",Z,[(s(!0),r(u,null,k(c.projects,e=>(s(),r("div",{class:"project",key:e.name},[a("div",$,[a("div",W,[v(e.name)?(s(),r("div",et,o(y(e.name)),1)):(s(),r("img",{key:0,class:"project-title",src:`/assets/img/logo/${e.name}.png`,alt:e.name},null,8,tt)),a("div",at,[m.value=="zh-CN"||m.value=="/zh/"?(s(),r(u,{key:0},[_.includes(e.name)?l("v-if",!0):(s(),r("a",{key:0,href:`https://gitee.com/dromara/${e.name}/stargazers`,target:"_blank"},[a("img",{src:`https://gitee.com/dromara/${e.name}/badge/star.svg?theme=gvp`},null,8,rt)],8,st))],64)):(s(),r(u,{key:1},[S.includes(e.name)?l("v-if",!0):(s(),L(b(U),{key:0,project:e.name},null,8,["project"]))],64))])]),a("div",it,o(e.description),1)]),a("div",ot,[e.sponsor?(s(),r("p",gt,o(b(t).PROJECT_SPONSOR)+"："+o(e.sponsor),1)):l("v-if",!0),e.date?(s(),r("p",mt,o(b(t).JOINING_DATE)+"："+o(e.date),1)):l("v-if",!0),a("p",{innerHTML:e.link},null,8,ht)]),a("div",ct,[a("a",{class:"project-button primary",href:e.website},o(b(t).START_UP),9,lt),_.includes(e.name)?l("v-if",!0):(s(),r("a",{key:0,class:"project-button",target:"_blank",href:`https://gitee.com/dromara/${e.name}`},"Gitee",8,nt)),S.includes(e.name)?l("v-if",!0):(s(),r("a",{key:1,class:"project-button",target:"_blank",href:`https://github.com/dromara/${e.name}`},"Github",8,pt))])]))),128))])]))),128))])],64))}});const ut=D(dt,[["__scopeId","data-v-451f9d94"],["__file","ProjectsPage.vue"]]);export{ut as P};
