import{_ as i,o as e,c as n,f as s}from"./app-b852c2ab.js";const l={},d=s(`<h2 id="🎉sms4j-3-0-0-版本震撼发布-短信重试-多方共用-负载均衡正式来袭-🎉" tabindex="-1"><a class="header-anchor" href="#🎉sms4j-3-0-0-版本震撼发布-短信重试-多方共用-负载均衡正式来袭-🎉" aria-hidden="true">#</a> 🎉sms4j 3.0.0 版本震撼发布 短信重试，多方共用，负载均衡正式来袭 🎉</h2><p>在历经了数月的等待之后（主要作者在摸鱼，写得慢。。。。）sms4j 的 3.0 版本终于正式发布，本次版本为大版本更新，与 2.x 不兼容，但是本次更新是一个长期支持版本，并且带来了诸多的新特性，接下来我们一起来看看吧</p><h2 id="🚀-新特性" tabindex="-1"><a class="header-anchor" href="#🚀-新特性" aria-hidden="true">#</a> 🚀 新特性</h2><ul><li>支持短信失败重试，可以自定义重试次数</li><li>支持单厂商多配置使用</li><li>支持接口类配置</li><li>支持自定义缓存来源</li><li>支持默认负载均衡形式，权重可自定义配置</li><li>支持邮件发送</li><li>支持邮箱监听</li><li>支持邮件发送失败自动重试</li><li>支持短信拦截</li></ul><h2 id="🏇-使用方式变更" tabindex="-1"><a class="header-anchor" href="#🏇-使用方式变更" aria-hidden="true">#</a> 🏇 使用方式变更</h2><p>在 sms4j3.0 版本中，使用方式与先前的 2.X 有所不同，使用上不再依托 2.X 中的枚举，而是改为更加自由的自定义 key 标识</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> SmsBlend smsBlend = SmsFactory.getSmsBlend(&quot;在配置中定义的configId&quot;);
