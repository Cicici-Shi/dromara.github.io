...
`}]}]);return t.DISTRIBUTED_TRANSACTION,t.DISTRIBUTED_SCHEDULING,(g,h)=>(s(),r(u,null,[a("div",Y,[a("div",H,[a("div",V,[a("h1",Q,o(b(t).PROJECTS),1),a("p",K,o(b(t).DESCRIPTION),1)])])]),a("main",X,[(s(!0),r(u,null,k(F.value,c=>(s(),r("div",{key:c.groupName,class:"project-group"},[a("h2",Z,o(c.groupName),1),a("div",$,[(s(!0),r(u,null,k(c.projects,e=>(s(),r("div",{class:"project",key:e.name},[a("div",W,[a("div",tt,[v(e.name)?(s(),r("div",at,o(y(e.name)),1)):(s(),r("img",{key:0,class:"project-title",src:`/assets/img/logo/${e.name}.png`,alt:e.name},null,8,et)),a("div",st,[m.value=="zh-CN"||m.value=="/zh/"?(s(),r(u,{key:0},[_.includes(e.name)?l("v-if",!0):(s(),r("a",{key:0,href:`https://gitee.com/dromara/${e.name}/stargazers`,target:"_blank"},[a("img",{src:`https://gitee.com/dromara/${e.name}/badge/star.svg?theme=gvp`},null,8,it)],8,rt))],64)):(s(),r(u,{key:1},[S.includes(e.name)?l("v-if",!0):(s(),L(b(z),{key:0,project:e.name},null,8,["project"]))],64))])]),a("div",ot,o(e.description),1)]),a("div",gt,[e.sponsor?(s(),r("p",mt,o(b(t).PROJECT_SPONSOR)+"："+o(e.sponsor),1)):l("v-if",!0),e.date?(s(),r("p",ht,o(b(t).JOINING_DATE)+"："+o(e.date),1)):l("v-if",!0),a("p",{innerHTML:e.link},null,8,ct)]),a("div",lt,[a("a",{class:"project-button primary",href:e.website},o(b(t).START_UP),9,nt),_.includes(e.name)?l("v-if",!0):(s(),r("a",{key:0,class:"project-button",target:"_blank",href:`https://gitee.com/dromara/${e.name}`},"Gitee",8,pt)),S.includes(e.name)?l("v-if",!0):(s(),r("a",{key:1,class:"project-button",target:"_blank",href:`https://github.com/dromara/${e.name}`},"Github",8,dt))])]))),128))])]))),128))])],64))}});const Ft=D(bt,[["__scopeId","data-v-7caf4318"],["__file","ProjectsPage.vue"]]);export{Ft as P};
