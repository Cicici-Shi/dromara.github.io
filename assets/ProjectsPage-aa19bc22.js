...
`}]}]);return(m,h)=>(s(),r(u,null,[a("div",U,[a("div",Q,[a("div",V,[a("h1",K,i(b(e).PROJECTS),1),a("p",X,i(b(e).DESCRIPTION),1)])])]),a("main",W,[(s(!0),r(u,null,A(F.value,c=>(s(),r("div",{key:c.groupName,class:"project-group"},[a("h2",Z,i(c.groupName),1),a("div",$,[(s(!0),r(u,null,A(c.projects,t=>(s(),r("div",{class:"project",key:t.name},[a("div",ee,[a("div",te,[y(t.name)?(s(),r("div",se,i(w(t.name)),1)):(s(),r("img",{key:0,class:"project-title",src:`/assets/img/logo/${t.name}.webp`,alt:t.name},null,8,ae)),a("div",re,[g.value=="zh-CN"||g.value=="/zh/"?(s(),r(u,{key:0},[_.includes(t.name)?l("v-if",!0):(s(),r("a",{key:0,href:`https://gitee.com/dromara/${t.name}/stargazers`,target:"_blank"},[a("img",{src:`https://gitee.com/dromara/${t.name}/badge/star.svg?theme=gvp`},null,8,ie)],8,oe))],64)):(s(),r(u,{key:1},[S.includes(t.name)?l("v-if",!0):(s(),P(b(Y),{key:0,project:t.name},null,8,["project"]))],64))])]),a("div",me,i(t.description),1)]),a("div",ge,[t.sponsor?(s(),r("p",he,i(b(e).PROJECT_SPONSOR)+"："+i(t.sponsor),1)):l("v-if",!0),t.date?(s(),r("p",ce,i(b(e).JOINING_DATE)+"："+i(t.date),1)):l("v-if",!0),a("p",{innerHTML:t.link},null,8,le)]),a("div",de,[a("a",{class:"project-button primary",href:t.website},i(b(e).START_UP),9,ne),_.includes(t.name)?l("v-if",!0):(s(),r("a",{key:0,class:"project-button",target:"_blank",href:`https://gitee.com/dromara/${t.name}`},"Gitee",8,pe)),S.includes(t.name)?l("v-if",!0):(s(),r("a",{key:1,class:"project-button",target:"_blank",href:`https://github.com/dromara/${t.name}`},"Github",8,be))])]))),128))])]))),128))])],64))}});const fe=v(ue,[["__scopeId","data-v-b19330e1"],["__file","ProjectsPage.vue"]]);export{fe as P};
