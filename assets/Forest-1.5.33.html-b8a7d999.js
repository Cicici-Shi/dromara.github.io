...
String simplePostWithSocksProxy();
        ...
        .username(&quot;foo&quot;)  // 验证用户名
        .password(&quot;bar&quot;); // 验证密码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="官网和仓库地址" tabindex="-1"><a class="header-anchor" href="#官网和仓库地址" aria-hidden="true">#</a> 官网和仓库地址</h2>`,37),v=e("h4",{id:"官网地址",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#官网地址","aria-hidden":"true"},"#"),i(" 官网地址:")],-1),h={href:"http://forest.dtflyx.com",target:"_blank",rel:"noopener noreferrer"},p=e("h4",{id:"gitee-仓库地址",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#gitee-仓库地址","aria-hidden":"true"},"#"),i(" Gitee 仓库地址:")],-1),m={href:"https://gitee.com/dromara/forest",target:"_blank",rel:"noopener noreferrer"},b=e("h4",{id:"github-仓库地址",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#github-仓库地址","aria-hidden":"true"},"#"),i(" Github 仓库地址:")],-1),x={href:"https://github.com/dromara/forest",target:"_blank",rel:"noopener noreferrer"},g=s('<h2 id="本次更新内容" tabindex="-1"><a class="header-anchor" href="#本次更新内容" aria-hidden="true">#</a> 本次更新内容</h2><blockquote><ul><li>feat: #I6MLMD 支持 socks 代理</li><li>feat: 组合注解支持属性重写</li><li>fix: #I7UPBR @Body 注解的数组参数无法正常解析为 JSON 数组</li><li>fix: #I7F3F0 Content-Type 为 application/xml 的情况下，发送 byte 数组数据错误</li><li>fix: #I7QLTS @JSONBody Collectioncodes 报错</li><li>add: SocksProxy 注解</li><li>add: OverrideAttribute 注解</li><li>opt: 优化 URL 更新方式</li><li>update: forest-solon-plugin 升级 solon 为：2.4.0</li></ul></blockquote><figure><img src="'+l+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',3);function f(q,y){const t=a("ExternalLinkIcon");return o(),r("div",null,[u,e("blockquote",null,[v,e("p",null,[e("a",h,[i("http://forest.dtflyx.com"),n(t)])]),p,e("p",null,[e("a",m,[i("https://gitee.com/dromara/forest"),n(t)])]),b,e("p",null,[e("a",x,[i("https://github.com/dromara/forest"),n(t)])])]),g])}const _=d(c,[["render",f],["__file","Forest-1.5.33.html.vue"]]);export{_ as default};
