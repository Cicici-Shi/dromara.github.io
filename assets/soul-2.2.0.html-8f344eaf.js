...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>这样网关的环境就已经搭建完成。</li></ul><h2 id="体验新架构下的插件热插拔" tabindex="-1"><a class="header-anchor" href="#体验新架构下的插件热插拔" aria-hidden="true">#</a> 体验新架构下的插件热插拔</h2>`,5),_=l("li",null,[l("p",null,"问：我想使用熔断功能，应该如何做呢？")],-1),f={href:"https://dromara.org/zh-cn/docs/soul/soul.html",target:"_blank",rel:"noopener noreferrer"},x=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  &lt;!-- soul hystrix plugin start--&gt;
  &lt;dependency&gt;
      &lt;groupId&gt;org.dromara&lt;/groupId&gt;
