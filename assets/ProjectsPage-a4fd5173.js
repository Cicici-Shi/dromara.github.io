...
`}]}]);return(g,c)=>(s(),r(u,null,[a("div",Q,[a("div",V,[a("div",K,[a("h1",X,i(b(e).PROJECTS),1),a("p",W,i(b(e).DESCRIPTION),1)])])]),Z,a("main",$,[(s(!0),r(u,null,A(F.value,l=>(s(),r("div",{key:l.groupName,class:"project-group"},[a("h2",ee,i(l.groupName),1),a("div",te,[(s(!0),r(u,null,A(l.projects,t=>(s(),r("div",{class:"project",key:t.name},[a("div",ae,[a("div",se,[k(t.name)?(s(),r("div",oe,i(T(t.name)),1)):(s(),r("img",{key:0,class:"project-title",src:`/assets/img/logo/${t.name}.webp`,alt:t.name},null,8,re)),a("div",ie,[h.value=="zh-CN"||h.value=="/zh/"?(s(),r(u,{key:0},[_.includes(t.name)?d("v-if",!0):(s(),r("a",{key:0,href:`https://gitee.com/dromara/${t.name}/stargazers`,target:"_blank"},[a("img",{src:`https://gitee.com/dromara/${t.name}/badge/star.svg?theme=gvp`},null,8,ge)],8,me))],64)):(s(),r(u,{key:1},[S.includes(t.name)?d("v-if",!0):(s(),P(b(U),{key:0,project:t.name},null,8,["project"]))],64))])]),a("div",he,i(t.description),1)]),a("div",ce,[t.sponsor?(s(),r("p",le,i(b(e).PROJECT_SPONSOR)+"："+i(t.sponsor),1)):d("v-if",!0),t.date?(s(),r("p",de,i(b(e).JOINING_DATE)+"："+i(t.date),1)):d("v-if",!0),a("p",{innerHTML:t.link},null,8,ne)]),a("div",pe,[a("a",{class:"project-button primary",target:"_blank",href:t.website},i(b(e).START_UP),9,be),_.includes(t.name)?d("v-if",!0):(s(),r("a",{key:0,class:"project-button",target:"_blank",href:`https://gitee.com/dromara/${t.name}`},"Gitee",8,ue)),S.includes(t.name)?d("v-if",!0):(s(),r("a",{key:1,class:"project-button",target:"_blank",href:`https://github.com/dromara/${t.name}`},"Github",8,Fe))])]))),128))])]))),128))])],64))}});const _e=w(fe,[["__scopeId","data-v-e82ec05a"],["__file","ProjectsPage.vue"]]);export{_e as P};
