import{_ as e,o as n,c as i,f as l}from"./app-fa6f7b80.js";const s={},d=l(`<h2 id="项目介绍" tabindex="-1"><a class="header-anchor" href="#项目介绍" aria-hidden="true">#</a> 项目介绍</h2><p>Binlog4j 是一款提供宕机续读，高可用集群，数据转换的 Binlog 客户端。</p><h2 id="项目特性" tabindex="-1"><a class="header-anchor" href="#项目特性" aria-hidden="true">#</a> 项目特性</h2><ul><li>集群模式, 通过集群部署的方式，保证服务高可用。</li><li>宕机续读, 避免宕机期间造成数据丢失。</li><li>数据转换, 基于泛型封装 BinlogEvent 的序列化数据。</li><li>兼容 传统项目 与 Spring Boot / Cloud 项目。</li><li>兼容 Spring Boot 2.x 与 Spring Boot 3.x 版本。</li></ul><h2 id="应用场景" tabindex="-1"><a class="header-anchor" href="#应用场景" aria-hidden="true">#</a> 应用场景</h2><p>包括但不限于（1）数据同步（2）实时计算（3）数据审计（4）数据分析</p><h2 id="下载安装" tabindex="-1"><a class="header-anchor" href="#下载安装" aria-hidden="true">#</a> 下载安装</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
