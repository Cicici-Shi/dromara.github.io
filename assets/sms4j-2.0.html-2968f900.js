import{_ as a,r as d,o as l,c as r,a as e,b as n,d as s,e as t}from"./app-cee4e0d2.js";const c="/assets/img/news/sms4j-cover.png",v={},m=t('<h2 id="sms4j-2-0-全新来袭" tabindex="-1"><a class="header-anchor" href="#sms4j-2-0-全新来袭" aria-hidden="true">#</a> sms4j 2.0 全新来袭</h2><p>即 sms-aggregation 成功加入 dromara 之后，很多人向我们反应了项目名称太长不好记，也太绕口， 在经过了有奖名称征集之后，我们定名为 sms4j 并伴随着大版本更新一同发布。这次更新不仅仅改变了项目名称，启用了新的 logo，还调整了项目结构，加入了更多新特性，下面我们一起来简单的看一下吧！</p><figure><img src="'+c+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="首先是-maven-的变化" tabindex="-1"><a class="header-anchor" href="#首先是-maven-的变化" aria-hidden="true">#</a> 首先是 maven 的变化</h2><p>老版本中，groupId 为作者的个人网站，同时也是项目的官网，在新的版本中统一改为了 Dromara 的地址</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
public class DemoController {
  ...
  sql:
    ...
    is-start: 1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>更多的新特性和功能不在这里一 一介绍了，具体的可以查看官方文档或者 gitee 仓库</p>`,15),u=e("strong",null,"官方文档",-1),o={href:"https://wind.kim/",target:"_blank",rel:"noopener noreferrer"},b=e("strong",null,"gitee 仓库",-1),p={href:"https://gitee.com/dromara/sms4j",target:"_blank",rel:"noopener noreferrer"},g=e("p",null,[e("strong",null,"您的支持是我们前进的动力，如果我们的项目对您产生了帮助或者您觉得还不错，请为我们点上一颗 star")],-1);function h(X,_){const i=d("ExternalLinkIcon");return l(),r("div",null,[m,e("p",null,[u,n(" "),e("strong",null,[e("a",o,[n("https://wind.kim/"),s(i)])])]),e("p",null,[b,n(" "),e("strong",null,[e("a",p,[n("https://gitee.com/dromara/sms4j"),s(i)])])]),g])}const x=a(v,[["render",h],["__file","sms4j-2.0.html.vue"]]);export{x as default};
